    ...
    data: {
      ...
      pariticipation: {
        ...
        form: {
          ...
          participantsKid: 'Makyaj / Kuaför Katılımcıları',
          addParticipantsKid: 'Makyaj / Kuaför Katılımcıları Ekle',
    ...
    data: {
      ...
      pariticipation: {
        ...
        form: {
          ...
          participantsKid: 'Учесници шминкер/фризьер',
          addParticipantsKid: 'Додати учеснике шминкер/фризьер',
